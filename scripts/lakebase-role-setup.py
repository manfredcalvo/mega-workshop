...
def main():
    ...
    grants = [
        ...
        ("CREATE SCHEMA IF NOT EXISTS ai_vectorstore", "Create ai_vectorstore schema"),
        ...
        (f'GRANT USAGE ON SCHEMA ai_vectorstore TO "{sp}"', "USAGE on ai_vectorstore"),
        (f'GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA ai_vectorstore TO "{sp}"', "ALL PRIVILEGES on ai_vectorstore tables"),
        (f'ALTER DEFAULT PRIVILEGES IN SCHEMA ai_vectorstore GRANT ALL PRIVILEGES ON TABLES TO "{sp}"', "Default privileges on ai_vectorstore"),
        (f'GRANT CREATE ON SCHEMA ai_vectorstore TO "{sp}"', "CREATE on ai_vectorstore"),
